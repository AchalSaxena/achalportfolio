...
export default function FloatingWhatsApp() {
  ...
  return (
    <a
      ...
      target="_blank"
      rel="noreferrer"
      className="fixed bottom-8 right-8 z-40 flex items-center justify-center w-12 h-12 rounded-full bg-brand-navy border border-white/10 text-white shadow-[0_4px_15px_rgba(15,23,42,0.25)] hover:bg-brand-cyan hover:border-brand-cyan hover:shadow-[0_0_20px_rgba(6,182,212,0.4)] transition-all duration-300 hover:-translate-y-1 focus:outline-none focus:ring-2 focus:ring-brand-cyan/50 group"
      aria-label="Chat on WhatsApp"
    >
      {/* Pulse effect rings */}
      <span className="absolute inline-flex h-full w-full rounded-full bg-brand-cyan opacity-25 animate-ping pointer-events-none"></span>
